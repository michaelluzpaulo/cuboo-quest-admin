                        ...
                        <tbody>
                            <?php $__currentLoopData = $gameUsuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                       <?php switch($g->status):
                                           case ('1'): ?> Aguardando Finalizar <?php break; ?>
                                           <?php case ('2'): ?> Vencedor <?php break; ?>
                                           <?php case ('3'): ?> Perdedor <?php break; ?>
                                           <?php case ('4'): ?> Desistiu da partida <?php break; ?>
                                           <?php default: ?> Desconhecido
                                          <?php endswitch; ?>
                                    </td>
                                </tr>
...
<?php /**PATH D:\work\www\bkp_2024\cuboo_group\mestre_dos_magos\mestre_dos_magos-web\Modules/Game\Resources/views/edit.blade.php ENDPATH**/ ?>