...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="/dist/js/modules/Option.js?v=<?php echo time(); ?>"></script>
...
<?php $__env->startSection('module_title'); ?>
    <h1><small>Cadastros /</small> Options</h1>
<?php $__env->stopSection(); ?>
    ...
    <section class="content">
        <div class="card card-secondary card-outline">
            <div class="card-header">
                ...
                <form name="form-option-principal" id="form-option-principal">
                    <div class="row">
                        <div class="col-lg-2">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\www\bkp_2024\cuboo_group\jogo_perguntas\admin\Modules/Option\Resources/views/index.blade.php ENDPATH**/ ?>