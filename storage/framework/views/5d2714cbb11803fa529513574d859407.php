<form id="temaForm" role="form" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="senha_final" class="control-label">Senha geral final (separados por ";")
                    </label>
                    <input type="text" class="form-control" name="senha_final" id="senha_final"
                        value="<?php echo $tema->senha_final; ?>">
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label for="game_fundo_central_cor" class="control-label">Cor de fundo game central </label>
                    <input type="color" class="form-control" name="game_fundo_central_cor"
                        id="game_fundo_central_cor" value="<?php echo $tema->game_fundo_central_cor; ?>" />
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="game_fundo_central_img" class="control-label">Imagem de fundo game (2000px):
                    </label>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="game_fundo_central_img" class="control-label">Imagem de fundo central game (2000px):
                    </label>
...
<?php /**PATH /Volumes/work/www/cuboo_group/think_group/adm/Modules/Tema/Resources/views/edit.blade.php ENDPATH**/ ?>