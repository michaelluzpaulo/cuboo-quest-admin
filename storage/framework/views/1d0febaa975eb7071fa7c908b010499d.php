<form id="gameForm" role="form" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="sabotador" class="control-label">Sabotador (ex: 4,8,12): </label>
                    <input type="text" class="form-control" name="sabotador" id="sabotador"
                        value="<?php echo e($game->sabotador ?? 0); ?>" disabled>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="salas_validas" class="control-label">Salas Válidas (1,2,3): </label>
                    <input type="number" min="1" max="3" class="form-control" name="salas_validas"
                        id="salas_validas" value="<?php echo e($game->salas_validas); ?>" disabled>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="status" class="control-label">Ganhador: </label>
                    <input type="text" class="form-control bg-green" name="status" id="status" maxlength="70"
                        value="<?php echo $ganhador; ?>"  disabled>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $gameUsuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($g->is_sabotador == 1 ? 'Sim' : 'Não'); ?>

                                    </td>
                                 <td>
                                        <?php if($g->is_sabotador): ?>
                                          Sabotador
                                         <?php elseif($g->is_quest_password): ?>
                                          Senha Correta
                                         <?php else: ?>
                                           Sem Senha
                                         <?php endif; ?>
...
<?php /**PATH D:\work\www\bkp_2024\cuboo_group\rpg\cuboo-rpg-admin\Modules/Game\Resources/views/edit.blade.php ENDPATH**/ ?>