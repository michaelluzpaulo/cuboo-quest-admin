...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="/dist/js/modules/Tema.js?v=<?php echo time(); ?>"></script>
...
<?php $__env->startSection('module_title'); ?>
    <h1><small>Cadastros /</small> Temas</h1>
<?php $__env->stopSection(); ?>
    ...
    <section class="content">
        <div class="card card-secondary card-outline">
            <div class="card-header">
                ...
                <form name="form-tema-principal" id="form-tema-principal">
                    <div class="row">
                        <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table id="temaTable" class="table table-striped dataTable table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\www\bkp_2024\cuboo_group\mestre_dos_magos\mestre_dos_magos-web\Modules/Tema\Resources/views/index.blade.php ENDPATH**/ ?>