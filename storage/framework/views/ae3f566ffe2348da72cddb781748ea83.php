<form id="temaForm" role="form">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label for="senha_final" class="control-label">Senha final: </label>
                    <input type="text" class="form-control" name="senha_final" id="senha_final" maxlength="255">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="game_fundo_img" class="control-label">Imagem de fundo game (2000px): </label>
...
<?php /**PATH /Volumes/work/www/cuboo_group/think_group/adm/Modules/Tema/Resources/views/create.blade.php ENDPATH**/ ?>