        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($agrupador ? $agrupador->nome : 'Nenhum'); ?>"
                        disabled>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="scenariosx" id="scenariosx" maxlength="70"
                         value="<?php echo e($scenarios->title ?? ''); ?>" disabled>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
...
<?php /**PATH D:\work\www\bkp_2024\cuboo_group\quest_group\cuboo-quest-admin\Modules/Game\Resources/views/edit.blade.php ENDPATH**/ ?>