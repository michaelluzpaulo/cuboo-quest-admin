    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:  #432D65;">
            ...
            <a href="/admin" class="brand-link" style="display: flex; justify-content: center;text-decoration: none;">
                ...
                <span class="brand-text"><strong> QUEST </strong></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/admin/scenarios" class="nav-link" style="color: #fff">
                                <i class="nav-icon fas fa-file-signature"></i>
                                <p>
                                    Cenários
                                </p>
...
<?php /**PATH D:\work\www\bkp_2024\cuboo_group\quest_group\cuboo-quest-admin\Modules/Admin\Resources/views/layouts/master.blade.php ENDPATH**/ ?>