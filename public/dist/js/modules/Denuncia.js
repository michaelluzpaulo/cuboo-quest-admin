const Denuncia = (function () {
  const _formIdPrincipal = "#form-denuncia-principal";
  const _formId = "#denunciaForm";
  const _tableId = "#denunciaTable";
  const _tableTdClass = "denunciaTableTd";
  const _modalId = "#denunciaModal";
  ...
  function __add() {
    $.loadmask();
    ModalFactory.create("denunciaModal", "lg");

    $(".modal-content", _modalId).load(
      "/admin/denuncias/create",
  ...
  function __save() {
    ...
    var url = id ? "/admin/denuncias/" + id : "/admin/denuncias";
  ...
  function __delete() {
    Notify.confirm(
      ...
      function () {
        $.ajax({
          type: "DELETE",
          url: "/admin/denuncias/" + $("#id", _formId).val(),
          dataType: "json",
          timeout: 120000,
          success: function (json) {
