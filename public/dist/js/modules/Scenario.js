const Scenario = (function () {
   const _formIdPrincipal = "#form-scenario-principal";
   const _formId = "#scenarioForm";
   const _tableId = "#scenarioTable";
   const _tableTdClass = "scenarioTableTd";
   const _modalId = "#scenarioModal";
   ...
   function __createTable() {
      $(_tableId).dataTable({
         ...
         fnServerParams: function (aoData) {
            ...
            aoData["search[title]"] = $("#filtro_title").val();
            aoData["search[scenarios]"] = $("#filtro_scenarios").val();
         },
         columnDefs: [
            {
               targets: [2, 3],
   ...
   function __add() {
      $.loadmask();
      ModalFactory.create("scenarioModal", "lg");
   ...
   function __update(id) {
      $.loadmask();
      ModalFactory.create("scenarioModal", "xl");
   ...
   function __save() {
      ...
      var url = id ? "/admin/scenarios/" + id : "/admin/scenarios";
   ...
   function __delete() {
      Notify.confirm(
         ...
         function () {
            $.ajax({
               type: "DELETE",
               url: "/admin/scenarios/" + $("#id", _formId).val(),
               dataType: "json",
               timeout: 120000,
